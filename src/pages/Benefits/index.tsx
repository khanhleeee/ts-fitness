...
import { ActivePage, BenefitType } from '~/shared/types'
...
const Benefits = (props: Props) => {
  ...
  return (
    ...
    >
      <motion.div
        onViewportEnter={() => setActivePage(ActivePage.Benefits)}
        initial='hidden'
        whileInView='visible'
      ...
      <div className='mt-16 items-center justify-between gap-20 md:flex'>
        {/* GRAPHIC */}
        <img src={BenefitsPageGraphic} alt="benefits" />
          ...
          <div className='relative'>
            ...
            >
              <HText>
                ...
                <span className="text-primary-main"> FIT</span>
              </HText>
            </motion.div>
          </div>
          {/* DESCRIPT */}
